...
extension View {
    ...
    public func introspectTableViewCell(customize: @escaping (UITableViewCell) -> Void) -> some View {
        introspect(selector: TargetViewSelector.ancestorOrSiblingContaining, customize: customize)
    }
    ...
    public func introspectPagedTabView(customize: @escaping (UICollectionView, UIScrollView) -> Void) -> some View {
    ...
    public func introspectTextView(customize: @escaping (UITextView) -> Void) -> some View {
    ...
    @available(iOS 14.0, *)
    @available(tvOS, unavailable)
    public func introspectColorWell(customize: @escaping (UIColorWell) -> Void) -> some View {
        introspect(selector: TargetViewSelector.siblingContaining, customize: customize)
    }
}
#endif
...
extension View {
    ...
    public func introspectTableViewCell(customize: @escaping (NSTableCellView) -> Void) -> some View {
        introspect(selector: TargetViewSelector.ancestorOrSiblingContaining, customize: customize)
    }
    ...
    public func introspectTextView(customize: @escaping (NSTextView) -> Void) -> some View {
        introspect(selector: TargetViewSelector.siblingContaining, customize: customize)
    }
    ...
    public func introspectTabView(customize: @escaping (NSTabView) -> Void) -> some View {
        introspect(selector: TargetViewSelector.siblingContaining, customize: customize)
    }
    
    /// Finds a `NSButton` from a `SwiftUI.Button`
    public func introspectButton(customize: @escaping (NSButton) -> Void) -> some View {
        introspect(selector: TargetViewSelector.siblingContaining, customize: customize)
    }
    
    /// Finds a `NSColorWell` from a `SwiftUI.ColorPicker`
    @available(macOS 11.0, *)
    public func introspectColorWell(customize: @escaping (NSColorWell) -> Void) -> some View {
        introspect(selector: TargetViewSelector.siblingContaining, customize: customize)
    }
}
#endif
